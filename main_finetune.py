...
import src.utils.mae_lr_decay as lrd
import src.utils.mae_misc as misc
from src.utils.mae_datasets import build_dataset
...
def get_args_parser():
    ...
    parser.add_argument('--data_set', default='image_folder', choices=['CIFAR10', 'IMNET', 'image_folder'],
